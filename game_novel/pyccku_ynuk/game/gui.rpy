...
define gui.text_font = "font/mplus-2p-regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "font/mplus-2p-regular.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "font/NotoSansCJKjp-Medium.otf"
...
define gui.name_xpos = 360 # Дмитрий смотри сам насчет этого
define gui.name_ypos = 0 # Дмитрий смотри сам насчет этого
...
## выравнивания.
define gui.name_xalign = 0.0 # Дмитрий смотри сам насчет этого
...
define gui.dialogue_xpos = 402 # при таких настройках МАКСИМУМ СИМВОЛОВ В СТРОКУ БЕЗ ПРОБЕЛА (при базовой высоте и длинне буквы): 73
define gui.dialogue_ypos = 75 # при таких настройках МАКСИМУМ СИМВОЛОВ В ОДНОМ СООБЩЕНИИ (при базовой высоте и длинне буквы): +-315
