...
# часть с Никитой 
    ...
    #hide main_exit_IRNITU
    #with fade
    #scene exit_ylitsa_IRNITU #Это короче вот эта картинка, когджа с политеха выходишь, и видишь типо часть перехода, Лермонтов, дорогу и елку.
    #"Выходя из универа, я заприметил одного парня, очень похожего на моего одногруппника."
    #show nikita_small at truecenter #поставь куда тебе по кайфу
    ...
    # gg "А почему ты именно сюда поступил?"
    # "Ну вопрос хоть и банальный, зато побольше узнаю о нем."
    # nikita "А куда мне надо было?"
    # nikita "Железнодорожный вуз в 2 раза хуже, по оценкам критиков, так что, выбор так сказать без выбора."
    # nikita "А ты почему выбрал именно этот факультет?"
    # gg "Да я шлепнул на несколько, и ни на один не прошел..."
    # gg "А из всех других, наша специальность меньше всех похожа на курсы фронтеэнд разработчика за 16000."
    # gg "Так что, я решил именно сюда."
    # "Ну ясен пень этот гений учился на бюджете спрашивать его об этом было по-моему, бессмысленно."
    # show nikita_happy 
    # nikita "ООО, прикольнооо(^0^), а я вот после ПТУ входные сдал без единой ошибки!"
    # "Нууууу конееечно..."
    # gg "А ты вообще способен ошибаться?"
    # gg "Просто даже чат гпт вроде ошибается, а ты ни разу."
    # nikita "Да мне просто очень повезло, ведь на вступительных вопросы были для даунов."
    # "Нууууу конеееееечно)))."
    # gg "Вот бы мне твое везение..."
    # nikita "Да ладно тебе."
    # nikita "Невезет в учебе, повезет в любви!" 
    # gg "Aхахах, я в это верю."
    # "Однако, до этого, любовь все же обходила меня стороной"
    # show nikita_deafault
    # nikita "Ой, а мне кстати сейчас налево, к общаге сворачивать."
    # nikita "Так что давай, приятного время припровождения."
    # gg "Ну ладно, пока."
    # "Пожaв ему руку, я повернул в сторону своего дома."
    # "Никита, это конечно что-то с чем-то."
    # "С виду обычный и умный парень, оказался сам себе на уме."
    # "Вот у него, вероятно, проблемок по-меньше будет в жизни, чем у меня."
    # "По крайней мере, по нему и не скажешь, что у него что-нибудь ести на уме, кроме учебы."
    # "С этими мыслями, я перешагнул порог своей квартиры..."
